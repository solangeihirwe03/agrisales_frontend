              ...
              <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    id="FirstName"
                    name="first_name"
                    class="mt-1 w-full  rounded-md border-gray-200 bg-white text-sm text-gray-700 p-2 border
                     shadow-sm"
                  />
                </div>
                ...
                <div class="col-span-6">
                  <label
                    for="Email"
                    class="block text-sm p-2 font-medium text-gray-700"
                  >
                    {" "}
                    Email{" "}
                  </label>
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label
                    ...
                    class="block text-smp p-2 font-medium text-gray-700"
                  >
